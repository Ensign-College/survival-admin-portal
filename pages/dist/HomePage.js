...
var HomePage = function () {
    ...
    return (React.createElement("div", { className: "min-h-screen p-8 bg-white" },
        ...
        isAuthenticated ? (React.createElement("div", { className: "flex flex-col p-2 pt-0 md:p-8 md:flex-row" },
            React.createElement("div", { className: "w-full pr-8 md:w-1/3 lg:w-full" },
                ...
                React.createElement("form", { onSubmit: handleSubmit, className: "mb-8" },
                    ...
                    React.createElement("div", { className: "mb-4" },
                        React.createElement("button", { onClick: toggleCardDetailsText, className: "text-blue-500 hover:underline" }, isCardDetailsTextOpen ? "Collapse" : "Add Card Details Text"),
                ...
                React.createElement("div", { className: "w-full pr-8 md:w-1/3 lg:w-full" },
                    React.createElement("button", { onClick: toggleNotificationForm, className: "px-4 py-2 mb-4 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 focus:outline-none focus:shadow-outline" }, "Notifications"),
                    isNotificationFormVisible && (React.createElement("form", { onSubmit: function (e) {
                            e.preventDefault();
                            if (notificationImage) {
                                // Call handleSendImageNotification if notificationImage has text
                                notificationService_1.handleSendImageNotification("all", notificationTitle, notificationDescription, notificationImage);
                            }
                            else {
                                // Call handleSendNotification otherwise
                                notificationService_1.handleSendNotification("all", notificationTitle, notificationDescription);
                            }
                        }, className: "mb-8", autoComplete: "off" },
                        React.createElement("div", { className: "mb-4" },
                            React.createElement("label", { className: "block mb-2 text-sm font-bold text-gray-700" }, "Title:"),
                            React.createElement("input", { autoComplete: "off", type: "text", name: "notificationTitle", value: notificationTitle, onChange: handleNotificationChange, className: "w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" })),
                        React.createElement("div", { className: "mb-4" },
                            React.createElement("label", { className: "block mb-2 text-sm font-bold text-gray-700" }, "Description:"),
                            React.createElement("textarea", { autoComplete: "off", name: "notificationDescription", value: notificationDescription, onChange: handleNotificationChange, className: "w-full h-32 px-3 py-2 text-gray-700 border rounded shadow appearance-none resize-y focus:outline-none focus:shadow-outline" })),
                        React.createElement("div", { className: "mb-4" },
                            React.createElement("label", { className: "block mb-2 text-sm font-bold text-gray-700" }, "Image URL:"),
                            React.createElement("input", { autoComplete: "off", type: "text", name: "notificationImage", value: notificationImage, onChange: handleNotificationChange, className: "w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" })),
                        React.createElement("button", { type: "submit", className: "px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 focus:outline-none focus:shadow-outline" }, "Send Notification"))))),
